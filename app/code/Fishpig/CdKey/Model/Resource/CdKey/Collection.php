...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
     ...
     * @var string
     */
    protected $_cdkeyOrderItemTable = null;
  ...
  //  protected $_reviewStoreTable = null;
   ...
   // protected $_addStoreDataFlag = false;
     ...
     * CD key data
     *
     * @var \Fishpig\CdKey\Helper\Data
     */
    protected $_cdkeyData = null;
  ...
  //  protected $_storeManager;
    ...
    public function __construct(
        ...
        \Fishpig\CdKey\Helper\Data $cdkeyData,
        \Magento\Framework\DB\Adapter\AdapterInterface $connection = null,
        \Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null
    ) {
        $this->_cdkeyData = $cdkeyData;
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->joinLeft(
            ['cdkey_oi' => $this->getCdKeyOrderItemTable()],
            'main_table.key_id = cdkey_oi.key_id',
            ['item_id']
        );
        return $this;
    }
...
*/
 ...
 /*  public function addStatusFilter($status)
    {
        if (is_string($status)) {
            $statuses = array_flip($this->_cdkeyData->getCdKeyStatuses());
...
*/
     ...
     * @return string
     */
    protected function getCdKeyTable()
    {
        if ($this->_cdkeyTable === null) {
            $this->_cdkeyTable = $this->getTable('cdkey_key');
        }
        return $this->_cdkeyTable;
    }
     ...
     * @return string
     */
    protected function getCdKeyOrderItemTable()
    {
        if ($this->_cdkeyOrderItemTable === null) {
            $this->_cdkeyOrderItemTable = $this->getTable('cdkey_key_order_item');
        }
        return $this->_cdkeyOrderItemTable;
    }
